...
- A cancel-replace of one leg kills its OCO partner; with per-signal brackets this is contained to a
  single leg, which is another reason for the §6.1 design.
